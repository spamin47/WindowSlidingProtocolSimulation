...
public class Station {
    ...
    public boolean send(int data){ // 0xff ff ff ff
        System.out.println("Sending " + data + " as " + Integer.toBinaryString(data));
        int count = 0;
    ...
    public byte[] nextTransmitFrame(){
        System.out.println("Calling next transmit frame.");
        ...
        int index =0;
        System.out.println("Transmitting frame...");
